...
S3_ACCESS_KEY = ''
S3_SECRET_KEY = ''
CLOUDFRONT_URL = 'https://d1vtlh2gjr59y.cloudfront.net'  # private bucket via CloudFront
...
def upload_file_to_s3(file, bucket_name):
    try:
        ...
        # Return the CloudFront URL for access
...
def welcome():
    ...
    # ✅ Do NOT modify user[7] — use image URL as stored in DB
